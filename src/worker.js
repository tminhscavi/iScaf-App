...
self.addEventListener('push', (event) => {
  ...
  try {
    ...
    const options = {
      ...
      badge: data.badge || '/icon-48x48.png',
      image: data.image,
...
self.addEventListener('notificationclick', (event) => {
  ...
  event.waitUntil(
    handleNotificationClick(clickAction, urlToOpen)
  )
})
...
async function cacheUrls(urls) {
  ...
  try {
    ...
    console.log('[SW] URLs cached successfully:', urls.filter(url => !failedUrls.includes(url)))
